...
&#42; Corresponding author &nbsp;&nbsp; &dagger; Co-first author

|        |  |
|   :-:    | -       |
| <video src='../images/research/pose_refine_single.mp4' autoplay loop muted playsinline width="200"></video> | __Kexin Zhang__&#42;, Dongjie Zhu, Nikolaus Grigorieff&#42;.  <br><br> [__DiffPose: Differentiable projection matching for fast pose inference in cryo-EM__](https://www.researchgate.net/publication/396499801_DiffPose_Differentiable_projection_matching_for_fast_pose_inference_in_cryo-EM)  <br><br> _ResearchGate_ (2025).|
| <img src='../images/research/gisapr.png' align="center" width="200" height="10"> | Dongjie Zhu&dagger;, __Kexin Zhang__&dagger;, Lingli Kong, Nikolaus Grigorieff&#42;.  <br><br> __GisAPR, a package refines atomic models against cryo-EM images without 3D volumes__  <br><br> _In preparation_ (2026).|
...
|        |  |
|   :-:    | -       |
| <img src='../images/publication/sub50kda.png' align="center" width="200" height="10"> | __Kexin Zhang__&#42;, Timothy Grant, Nikolaus Grigorieff&#42.  <br><br> [__Improved Cryo-EM Reconstruction of Sub-50 kDa Complexes Using 2D Template Matching__](https://doi.org/10.7554/eLife.109790.1)  <br><br> _eLife_ (2026).|
